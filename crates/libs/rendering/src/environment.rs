use crate::brdf::create_brdf_lookup;
use crate::cubemap::create_skybox_cubemap;
use crate::irradiance::create_irradiance_map;
use crate::pre_filtered::create_pre_filtered_map;
...
pub fn get_view_matrices() -> [Matrix4<f32>; 6] {
    [
...
pub fn create_descriptors(context: &Arc<Context>, texture: &Texture) -> Descriptors {
...
#[derive(Copy, Clone)]
pub struct EnvPipelineParameters<'a> {
...
pub fn create_env_pipeline<V: Vertex>(
    context: &Arc<Context>,
